...
import LogoMini from "../../assets/template_assets/images/logo-mini.svg"
import ProfileImg from "../../assets/template_assets/images/faces/face28.png"

export default function Navbar(){
    return (
        <nav className="navbar navbar-dark default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div className="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
          <a className="navbar-brand brand-logo" href="index.html"><img src={LogoDark} alt="logo" /></a>
            ...
            <li className="nav-item nav-profile dropdown">
              ...
              <div className="dropdown-menu navbar-dropdown dropdown-menu-right p-0 border-0 font-size-sm" aria-labelledby="profileDropdown" data-x-placement="bottom-end">
                <div className="p-3 text-center bg-primary">
                  <img className="img-avatar img-avatar48 img-avatar-thumb" src={ProfileImg} alt="" />
                </div>
                <div className="p-2">
